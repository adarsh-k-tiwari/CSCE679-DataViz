(function() { 
    ...
    d3.csv("temperature_daily.csv").then(function(data) {
        ...
        // Define color scales for maximum(Orange) and minimum(Blue) temperature
        ...
        function createHeatmap(tempType) {
            ...
            // Determine which color scale to use based on max or min button clicked
            const colorScale = tempType === "max_temperature" ? maxTempColorScale : minTempColorScale;
            
            // Create cells of heatmap
            svg.selectAll(".cell")
                .data(monthlyData)
                .enter()
                .append("rect")
        ...
        function createLegend(tempType) {
            ...
            // Determine which color scale to use for legend
            const colorScale = tempType === "max_temperature" ? maxTempColorScale : minTempColorScale;
        ...
        // Maximum Temperature Button event handler
        ...
        // Minimum Temperature Button event handler
        ...
        // Function to process monthly temperatures
        function processData(rawData) {
            ...
            rawData.forEach(d => {
                ...
                // CHeck if current year/month already exists
